...
const AuthNav = ({ handleUserSidebar, onClickLogout }) => {
  return (
    <>
      <nav className={styles.header__nav}>
        <ul className={classNames(styles.nav__list, 'list-reset')}>
          ...
          <li className={styles.nav__item}>
            <button
              type='button'
              className={classNames(styles.nav__link, 'btn-reset')}
      ...
      <div className={classNames(styles['sign-up'], styles['header__sign-up'])}>
        <button
          className={classNames(styles['sign-up__link'], 'btn-reset')}
          type='button'
